...
namespace PartyBot.Modules
{
    public class SearchModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task SearchOpeningsLinks([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "opening", false, true));
        ...
        public async Task SearchOpeningsExactLinks([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "opening", true, true));
        [Command("SearchED")]
        [Summary("Type the name of a show or a substring of it's name in English or Romaji form and this will return" +
        ...
        public async Task SearchEndingsLinks([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "ending", false, true));
        ...
        public async Task SearchEndingsExactLinks([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "ending", true, true));
        [Command("SearchINS")]
        [Summary("Type the name of a show or a substring of it's name in English or Romaji form and this will return" +
        ...
        public async Task SearchForSongLinks([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "any", false, true));
        ...
        public async Task SearchForSongLinksExact([Remainder] string showName)
            => await ReplyAsync(embed: await DBSearchService.SearchForShow(Context.Message, showName, "any", true, true));
